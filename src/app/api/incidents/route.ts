  ...
  try {
    ...
    const incident = await db.incident.create({
      data: {
        ...
        packageContract: body.packageContract || null,
        briefIncidentTitle: body.briefIncidentTitle || null,
        isAnyoneInjured: body.isAnyoneInjured ?? false,
        isOngoing: body.isOngoing ?? false,
        immediateActionRequired: body.immediateActionRequired ?? false,
        authoritiesContacted: body.authoritiesContacted ?? false,
        ...
        partAStatus: 'Logged',
        partBStatus: body.partB ? 'Draft' : 'Not Started',
        partCStatus: body.partC ? 'Draft' : 'Not Started',
