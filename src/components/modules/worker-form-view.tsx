...
// ---------- main ----------
export default function WorkerFormView() {
    ...
    <div className="max-w-3xl mx-auto">
      ...
      <div className="flex items-center gap-4 mb-6">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-0.5">
            {isEdit ? 'Update worker information' : 'Fill in the details step by step to register a new worker'}
          </p>
        </div>
      </div>
      ...
      <Form {...form}>
        <form onSubmit={(e) => e.preventDefault()}>
          ...
          {/* ====== Wizard Footer (navigation) — sticky at bottom ====== */}
          <div className="sticky bottom-0 z-10 -mx-4 px-4 pt-4 pb-4 mt-6 bg-background/95 backdrop-blur-sm border-t border-border">
