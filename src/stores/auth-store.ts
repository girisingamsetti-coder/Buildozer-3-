...
export const rolePermissions: Record<UserRole, {
  ...
  ADMIN: {
    ...
    canViewMedical: true,
    canViewPOSH: true,
    modules: ['dashboard', 'workers', 'locations', 'medical', 'training', 'attendance', 'incidents', 'grievance', 'vehicles', 'hazardous', 'legal', 'compliance', 'es-forms', 'settings', 'reports', 'procurement'],
  },
  SAFETY_OFFICER: {
    canEdit: true,
  ...
  PMC: {
    ...
    canViewPOSH: false,
    modules: ['dashboard', 'workers', 'locations', 'medical', 'training', 'incidents', 'vehicles', 'legal', 'compliance', 'es-forms', 'settings', 'reports', 'procurement'],
  },
  HR_COORDINATOR: {
    canEdit: true,
    canViewAllContractors: false,
    ...
    canViewMedical: false,
    canViewPOSH: false,
    modules: ['dashboard', 'workers', 'locations', 'attendance', 'compliance', 'es-forms', 'settings', 'reports', 'procurement'],
  },
  LEGAL_ADVISOR: {
    canEdit: false,
    canViewAllContractors: true,
    ...
    canViewMedical: false,
    canViewPOSH: true,
    modules: ['dashboard', 'workers', 'locations', 'legal', 'compliance', 'es-forms', 'settings', 'reports', 'procurement'],
  },
}
